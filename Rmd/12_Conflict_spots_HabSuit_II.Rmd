---
title: "Conflict Maps (V) - Ha - Habitat Suitability (Current)"
...
def <- raster("./Proyecto/Conflict_Ha_TSS.tif")
...
# Convert to raster
rasterz <- raster(spz)
plot(rasterz,axes=F,main = expression("Conflict | Ha | Habitat Suitability"))
```
...
```{r}
writeRaster(x=rasterz, filename = "./Proyecto/Results_hab/Hotspot_Conflict_Ha_HS.tif", format="GTiff", overwrite=TRUE)
```
